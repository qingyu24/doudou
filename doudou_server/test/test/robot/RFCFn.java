...
public class RFCFn
{
	...
	public static void RoomImpl_visitGame(Robot r, int roomID)
	{
		r.GetSendBuffer().Clear().AddID(1,37).Add(roomID).Send(r.GetLink());
	}
	...
	public static void CenterDateImpl_rankingClass(Robot r, int len$, int i$, int this)
	{
		r.GetSendBuffer().Clear().AddID(7,9).Add(len$).Add(i$).Add(this).Send(r.GetLink());
	}
	...
	public static void CenterDateImpl_givePresent(Robot r, long this, int p_user, int friendID, String giftID)
	{
		r.GetSendBuffer().Clear().AddID(7,5).Add(this).Add(p_user).Add(friendID).Add(giftID).Send(r.GetLink());
	}
