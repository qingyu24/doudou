...
public class RFCFn
{
	...
	public static void CenterImpl_InvitationFriend(Robot r, long p_ID, int p_teamID, long m_friendID)
	{
		r.GetSendBuffer().Clear().AddID(3,3).Add(p_ID).Add(p_teamID).Add(m_friendID).Send(r.GetLink());
	}
